...
SeedHelper.create_request(organisation: organisation1, coordinator: coordinator1, text: 'Potřebujeme 5 dobrovolníků', required_volunteer_count: 5, subscriber: 'Subscriber', subscriber_phone: '+420 555 555 555', creator: User.first, state_last_updated_at: DateTime.now, zipcode: '77900', city: 'Olomouc', street: '17. listopadu 1192')
SeedHelper.create_request(organisation: organisation1, coordinator: coordinator1, text: 'Potřebujeme 10 dobrovolníků', required_volunteer_count: 10, subscriber: 'Subscriber', subscriber_phone: '+420 555 555 555', creator: User.first, state_last_updated_at: DateTime.now, state: :pending_confirmation, zipcode: '77900', city: 'Olomouc', street: '17. listopadu 1192')
SeedHelper.create_request(organisation: organisation1, coordinator: coordinator1, text: 'Potřebujeme 12 dobrovolníků', required_volunteer_count: 12, subscriber: 'Subscriber', subscriber_phone: '+420 555 555 555', creator: User.first, state_last_updated_at: DateTime.now, state: :pending_confirmation, zipcode: '77900', city: 'Olomouc', street: '17. listopadu 1192')
SeedHelper.create_request(organisation: organisation2, text: 'Potřebujeme 5 dobrovolníků', required_volunteer_count: 5, subscriber: 'Subscriber', subscriber_phone: '+420 555 555 555', creator: User.first, state_last_updated_at: DateTime.now, zipcode: '77900', city: 'Olomouc', street: '17. listopadu 1192')
SeedHelper.create_request(organisation: organisation1, coordinator: coordinator3, text: 'Potřebujeme 8 dobrovolníků', required_volunteer_count: 8, subscriber: 'Subscriber', subscriber_phone: '+420 555 555 555', creator: User.first, state_last_updated_at: DateTime.now, zipcode: '77900', city: 'Olomouc', street: '17. listopadu 1192')
