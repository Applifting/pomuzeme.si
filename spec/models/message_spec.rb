...
RSpec.describe Message, type: :model do
  ...
  context 'enums' do
    ...
    it { should define_enum_for(:channel).with_values(sms: 1) }
    it { should define_enum_for(:message_type).with_values(other: 1, request_offer: 2).with_prefix(:message_type) }
  end
